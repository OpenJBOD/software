  ...
  async def settings_users(req):
    if req.method == "POST":
      ...
      if req.form.get('user_1_cp'):
        CONFIG['web']['users']['1']['password'] = helpers.create_hash(req.form['user_1_p'])
      ...
      if req.form.get('user_2_cp'):
        CONFIG['web']['users']['2']['password'] = helpers.create_hash(req.form['user_2_p'])
      ...
      if req.form.get('user_3_cp'):
        CONFIG['web']['users']['3']['password'] = helpers.create_hash(req.form['user_3_p'])
      ...
      if req.form.get('user_4_cp'):
        CONFIG['web']['users']['4']['password'] = helpers.create_hash(req.form['user_4_p'])
      ...
      if req.form.get('user_5_cp'):
        CONFIG['web']['users']['5']['password'] = helpers.create_hash(req.form['user_5_p'])
